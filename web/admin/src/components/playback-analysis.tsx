...
type AnalysisRow = { id: string; title: string; episodeTitle: string | null; type: string; seasonNumber: number | null; episodeNumber: number | null; libraryName: string; fileStatus: string; durationMs: number | null; status: string; markers: Marker[]; updatedAt: string; asset: { status: string; frameCount: number; sheetCount: number; generatedAt: string | null; error: string | null } | null };
