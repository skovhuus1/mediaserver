...
import { ArrowRight, Clock3, Film, Layers3, LoaderCircle, Search, Tv, UserRound, X } from 'lucide-react';
...
type SearchResponse = { query: string; total: number; groups: { titles: TitleResult[]; people: PersonResult[]; genres: GenreResult[] } };
