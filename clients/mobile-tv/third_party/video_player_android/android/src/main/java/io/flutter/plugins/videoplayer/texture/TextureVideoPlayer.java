...
import io.flutter.plugins.videoplayer.BoltBytesPlaybackTuning;
    ...
    return new TextureVideoPlayer(
        ...
        () -> {
          ...
          if (options.boltBytesTvMode) {
            builder.setLoadControl(BoltBytesPlaybackTuning.loadControl(options));
          } else if (options.backBufferDurationMs != null) {
          ...
          BoltBytesPlaybackTuning.applyVideoScaling(player, options);
          return player;
        });
  }
