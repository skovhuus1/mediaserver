...
- Live TV-leverancen er lokalt verificeret 23. august 2026 med gyldig Prisma-schema, grøn lint og typecheck, 194 API-tests, 33 worker-tests, 7 release-tests samt production builds af contracts, API, worker og admin.
